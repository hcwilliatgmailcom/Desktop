...
public partial class MyCmdbContext : DbContext
{
    public MyCmdbContext()
    {
    }

    public MyCmdbContext(DbContextOptions<MyCmdbContext> options)
        : base(options)
    {
    }
    ...
    public virtual DbSet<Cmdbactor> Cmdbactors { get; set; }
...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see https://go.microsoft.com/fwlink/?LinkId=723263.
        => optionsBuilder.UseMySql("server=hcwilli.at;port=3306;user=d0424dc5;password=3QHu9nnDesLrDbKF44vN;database=d0424dc5", Microsoft.EntityFrameworkCore.ServerVersion.Parse("10.11.8-mariadb"));
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<Cmdbactor>(entity =>
        {
            entity
                .HasNoKey()
                .ToView("cmdbactor");
